...
class MUNIT_Trainer(nn.Module):
    ...
    def gen_update(self, x_a, x_b, hyperparameters, x_a_rand=None, x_b_rand=None):
        ...
        # print('x_a: {0}'.format(x_a.shape))   
        # print('s_a: {0}'.format(s_a_prime.shape)) 
        # print('c_a: {0}'.format(c_a.shape))
        ...
        # print("loss: ",self.loss_gen_total.item())
        if not torch.any(torch.isnan(self.loss_gen_total)):
